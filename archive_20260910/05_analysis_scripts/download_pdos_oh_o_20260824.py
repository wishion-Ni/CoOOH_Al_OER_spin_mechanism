...
REMOTE_BASE = PurePosixPath(
    ...
    "cohp_oh_o_corrected_20260820"
)
CASES = {
    "undoped_OH": REMOTE_BASE / "undoped_control/OH",
    "undoped_O": REMOTE_BASE / "undoped_control/O",
    "Al16_OH": REMOTE_BASE / "Al16_adjacent/OH",
    "Al16_O": REMOTE_BASE / "Al16_adjacent/O",
}
...
def main() -> None:
    ...
    target = Path(__file__).resolve().parent / "pdos_oh_o_inputs_20260824"
    ...
    try:
        ...
        for name, remote_dir in CASES.items():
            ...
            for filename in ("DOSCAR", "POSCAR", "INCAR", "OSZICAR"):
